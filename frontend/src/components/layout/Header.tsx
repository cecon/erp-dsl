 ...
 * Renders breadcrumbs, search, notifications, Otto toggle,
 * settings gear, and user area.
 */
export function Header() {
  ...
  const openThemeDrawer = useThemeStore((s) => s.openThemeDrawer);
  const { toggle: toggleOtto, opened: ottoOpened } = useOttoContext();
  ...
  return (
    <div className="admin-header">
      ...
      <div className="header-right">
        ...
        {/* Settings */}
        <Tooltip label="Configurações" position="bottom">
          <ActionIcon
            variant="subtle"
            color="gray"
            size="lg"
